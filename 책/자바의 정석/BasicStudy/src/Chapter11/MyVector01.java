...
//import java.util.*;
//
//public class MyVector01 implements List {
...
//		if(this.capacity==capacity) return; // 크기 같으면 변경하지 않는다.
//		
...
//	public ListIterator listInterator() { return null; }
//	public ListIterator listInterator(int index) { return null; }
